...
#ifndef EDITRELATIONNAME_H
#define EDITRELATIONNAME_H
...
class EditRelationName : public QDialog
{
    Q_OBJECT
    
public:
    explicit EditRelationName(QWidget *parent = 0);
    ~EditRelationName();
    //static
    static void edit(MainWindow* window);
    //member functions
...
private:
    ...
    void initialise();
    //member variables
    Ui::EditRelationName *ui;
};

#endif // EDITRELATIONNAME_H
