...
#ifndef HOMOGENOUSOPERATION_H
#define HOMOGENOUSOPERATION_H
...
class HomogenousOperation : public AbstractOperation
{
    Q_OBJECT
public:
    explicit HomogenousOperation(RF_RELATION* (*operation)(RF_DOMAIN*, RF_ERROR*),
                                 const QString &name, const QString &displayText,
                                 QObject *parent = 0);
    int executeOperation(RelationData* relation, const DomainData* domain) const;
signals:
    
public slots:

private:
    RF_RELATION* (*m_operation)(RF_DOMAIN*, RF_ERROR*);
    
};

#endif // HOMOGENOUSOPERATION_H
